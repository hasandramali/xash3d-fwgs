...
//-----------------------------------------------------------------------------
// Purpose: Font class (Win32 GDI on Windows, stb_truetype on other platforms)
//-----------------------------------------------------------------------------
class CWin32Font
{
public:
	...
	bool IsValid( void ) { return m_szName[0] != '\0'; }
	const char* GetName( void ) { return m_szName; }
	int GetHeight( void ) { return m_iHeight; }
	int GetAscent( void ) { return m_iAscent; }
	int GetMaxCharWidth( void ) { return m_iMaxCharWidth; }
	int GetFlags( void ) { return m_iFlags; }
	bool GetUnderlined( void ) { return m_bUnderlined; }
...
private:
	...
	struct abc_cache_t { wchar_t wch; abc_t abc; };
