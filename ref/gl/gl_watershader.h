...
typedef struct
{
	...
	GLint   u_strengthRefrUnder;
	GLint   u_waterColor;
	GLint   u_waterGamma;
	GLint   u_alpha;
	GLint   u_distScale;
	GLint   u_distColor;
	GLint   u_causticIntensity;
	GLint   u_causticColor;
	GLint   u_diffuseOverlay;
	GLint   u_fogBlend;
	GLint   u_fogColor;
	GLint   u_fogStart;
	GLint   u_fogEnd;
...
extern convar_t r_water_strength_under;
...
extern convar_t r_water_distcolor_r;
extern convar_t r_water_distcolor_g;
extern convar_t r_water_distcolor_b;
extern convar_t r_water_fogblend;
extern convar_t r_water_caustic_intensity;
extern convar_t r_water_caustic_color_r;
extern convar_t r_water_caustic_color_g;
